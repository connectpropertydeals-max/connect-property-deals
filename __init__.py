...
def create_app():
    ...
    sample_listings = [
        ...
        {"id": 5, "title": "Connecticut Starter Home", "city": "Milford, CT", "price": "$379,000", "beds": 3, "baths": 2, "sqft": 1520, "type": "Home", "tag": "Value", "desc": "Clean starter home close to local shopping, highways, and commuter access."},
        {"id": 6, "title": "Bridgeport Off-Market Fixer", "city": "Bridgeport, CT", "price": "$189,000", "beds": 3, "baths": 1, "sqft": 1280, "type": "Fixer", "tag": "Off-Market", "desc": "Investor-friendly rehab opportunity with upside for resale or rental strategy."}
    ]
    ...
    sample_agents = [
        ...
        {"name": "Marcus Hill", "market": "Connecticut", "specialty": "Off-market and value-add deals", "plan": "Featured"}
    ]

    @app.route("/")
    def home():
        return render_template("home.html", listings=sample_listings[:4], agents=sample_agents[:3])
    ...
    def listings():
        ...
        if q:
            filtered = [x for x in sample_listings if q in x["title"].lower() or q in x["city"].lower() or q in x["type"].lower()]
    ...
    def sell():
        ...
        return render_template("sell.html", success=success)
    ...
    def dashboard():
        stats = {
            ...
            "promoted_listings": 12,
            "monthly_leads": 217
        }
        return render_template("dashboard.html", stats=stats, listings=sample_listings[:4])
